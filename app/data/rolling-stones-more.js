window.initialSongs.push(
  {
    ...
    videoUrl: "",
    chords: [
      { name: "C#", frets: "x46664", fingers: "342111" },
      { name: "B", frets: "x24442", fingers: "234111" },
      { name: "A", frets: "x02220", fingers: "123" },
      { name: "E", frets: "022100", fingers: "231" }
    ],
    strumming: [
      { name: "Main movement", bpm: "", beats: ["D", "", "D", "U", "", "U", "D", "U"], accents: [0, 4], chordRun: "C#  B  A  E A E  A E  A E B", note: "Use the intro image for the exact rhythm guitar picking." }
    ],
    chart: `[Rhythm Guitar Intro]
