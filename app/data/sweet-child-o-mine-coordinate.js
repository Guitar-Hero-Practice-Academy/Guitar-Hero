const sweetChildOMineCoordinate = window.initialSongs.find((song) => song.id === "guns-n-roses-sweet-child-o-mine");

if (sweetChildOMineCoordinate) {
  sweetChildOMineCoordinate.contentRevision = 2;
  sweetChildOMineCoordinate.chart = `[Tuning]
Eb Ab Db Gb Bb Eb

[Intro riff]
[[image:assets/sweet-child-o-mine-intro.png|Intro riff]]
