window.initialSongs.push({
  id: "men-without-hats-the-safety-dance",
  contentRevision: 1,
  ...
  strumming: [
    {
      ...
      accents: [0, 4],
      chordRun: "B  A  E  F#",
      note: "Keep the synth-pop pulse even; let the B to A-E movement snap cleanly."
    }
  ],
  chart: `[Intro riff - capo 1]
e|--------------------|
B|--------------------|
G|--------------------|
D|--------------------|
