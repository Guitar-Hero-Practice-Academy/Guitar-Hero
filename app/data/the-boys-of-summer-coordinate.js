const boysOfSummerCoordinateSong = window.initialSongs.find((song) => song.id === "don-henley-the-boys-of-summer");

if (boysOfSummerCoordinateSong) {
  boysOfSummerCoordinateSong.contentRevision = 2;
  boysOfSummerCoordinateSong.chart = `[Intro riff]
